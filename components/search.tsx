...
import { TranslationItem } from '../utils/contentLoader';
...
export function prepareSearchData(pages: TranslationItem[]) {
  return pages.map((page) => ({
    term: page.term,
    translations: page.translations.map((item) => item.text).join(', '),
    path: `/terms/${page.term}`,
  }));
}
